---
date: {{TODAY}}
type: linkedin-snapshot
last-updated: {{TODAY}}
---

# LinkedIn Current State

The verified record of what is **actually live** on {{USER_NAME}}'s LinkedIn profile right now. Only update this file when a change has been published — it is a factual record, not a draft.
